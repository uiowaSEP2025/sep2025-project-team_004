...
class Fav_Sensor(models.Model):
    sensor = models.ForeignKey(
        ...
        related_name="fav_entries")             
    user   = models.ForeignKey(User, on_delete=models.CASCADE,
                               related_name="favourite_sensors")
...
class Belongs(models.Model):
    sensor = models.OneToOneField(
        Sensor, primary_key=True, on_delete=models.CASCADE,
        related_name="belongs_info")            
    user        = models.ForeignKey(User, on_delete=models.CASCADE,
                                    related_name="owned_sensors")
