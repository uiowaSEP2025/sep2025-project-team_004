...
urlpatterns = [
    ...
    path('<str:sensor_id>/update-favorite/', UpdateFavoriteSensorView.as_view(), name='update-fav-sensor'),
    path('<str:sensor_id>/update-belongs/', UpdateBelongsSensorView.as_view(), name='update-belongs-sensor'),
]
